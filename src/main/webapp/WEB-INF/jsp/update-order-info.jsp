        ...
        <div class="col">
            <div class="btn-container">
                <div class="centered-buttons">
                    ...
                    <form:form action="saveAfterUpdateOrder" modelAttribute="order">
                        <form:hidden path = "id"/>
                        <div class="m-3">
                            <h5>User</h5>
                        </div>
                        <div>
                            <form:select cssStyle="width: 200px" path="username">
                                <form:option value="Ihor" label="Ihor"/>
                                <form:option value="Oleg" label="Oleg"/>
                            </form:select>
                        </div>
                        <div class="m-3">
                            <h5>Description</h5>
                        ...
                        <div>
                            <form:select cssStyle="width: 200px" path="status">
                        ...
                        <div>
                            <input class="btn btn-secondary m-3" type="button" value="Back" onclick="window.location.href='/orders'">
                        </div>
                    </form:form>
                </div>
            </div>
